 ...
 * @version    1.0
 */
class Peexl_PackageBuilder_Block_Adminhtml_Product_Edit_Tab_Package_Item_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function getGridUrl() {
        return $this->getUrl('package/adminhtml_package_selection/grid', array('index' => $this->getIndex(), 'productss' => implode(',', $this->_getProducts())));
    }
    ...
    public function getAllowedSelectionTypes() {
        return Mage::helper('packagebuilder')->getAllowedSelectionTypes();
    }
