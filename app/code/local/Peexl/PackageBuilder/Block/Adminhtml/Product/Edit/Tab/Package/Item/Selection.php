 ...
 * @version    1.0
 */
class Peexl_PackageBuilder_Block_Adminhtml_Product_Edit_Tab_Package_Item_Selection extends Mage_Adminhtml_Block_Widget {

    public function __construct() {
        $this->setTemplate('package/product/edit/tab/package/item/selection.phtml');
    }
    ...
    public function getSelectionSearchUrl() {
        return $this->getUrl('package/adminhtml_package_selection/search');
    }
