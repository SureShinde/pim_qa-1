<?php
class Peexl_ProductCustomAttributes_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends
Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option {
    public function __construct() {
        parent::__construct();
       // $this->setTemplate('peexl_productcustomattributes/catalog-product-edit-options-option.phtml');
        // Mage::log('Peexl_ProductCustomAttributes_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option',false, 'ProductCustomAttributes.log');
    }
                    ...
                    foreach ($option->getValues() as $_value) {
                        ...
                        $value['optionValues'][$i] = array(
                         ...
                         if($_value->getImage()){
                                          $imgOption=array(
                                            'label'=>"Delete Image",
                                            'url'=>Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA). DS . 'productcustomoptions' . DS .$_value->getImage()
                                            );

                             $imgHtml=Mage::helper('peexl_productcustomattributes')->getImageView(new Varien_Object($imgOption));                                             
                             $value['optionValues'][$i]["image"]=$imgHtml;
                          }
