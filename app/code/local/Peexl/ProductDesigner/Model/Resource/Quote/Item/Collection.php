...
class Peexl_ProductDesigner_Model_Resource_Quote_Item_Collection extends Mage_Sales_Model_Resource_Quote_Item_Collection {
    ...
    protected function _assignProducts() {
        ...
        foreach ($this as $item) {
            ...
            if ($product) {
                ...
                if ($designId = $item->getBuyRequest()->getDesignId()) {
                    $product = clone $product;
                    $product->setDesignId($designId);
                }
