...
class Peexl_ProductDesigner_Adminhtml_Product_Edit_Tab_Designer_DesignsController extends Mage_Adminhtml_Controller_Action {
    ...
    public function gridAction() {
        if($deleteDesignId = $this->getRequest()->getParam('delete')) {
            $design = Mage::getModel('productdesigner/design')->load($deleteDesignId);
            if($design->getId()) {
                $design->delete();
            }
        }
        $this->loadLayout();
        $this->getLayout()->getBlock('adminhtml.product.edit.tab.designer.designs.grid');
